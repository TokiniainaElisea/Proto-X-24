...
<div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
            <div class="d-flex justify-content-center gap-2"> {{-- Sélectionner un client --}} <button type="button"
                    class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#client_list"> <i
                        class="bi bi-person-check-fill me-1"></i> Sélectionner un client </button> {{-- Nouveau client --}}
                <button type="button" class="btn btn-outline-success" data-bs-toggle="modal"
                    data-bs-target="#new_client"> <i class="bi bi-person-plus-fill me-1"></i> Nouveau client </button>
            </div>
